    ...
    */
    ...
    p.langChangeHandler = function (e) {
        if (this.settings.textkey) {
            this.setText(language.getTextByKey(this.settings.textkey), true);
        }
    };
    ...
    function _textInit() {
        ...
        if (this.settings.text !== undefined && this.settings.text !== '') {
            if (language.isKey(this.settings.text) === false) {
                this.setText(this.settings.text);
            } else {
                this.setTextKey(language.parseKey(this.settings.text), false);
            }
        }
