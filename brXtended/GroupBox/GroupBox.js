...
define([
    ...
    'widgets/brXtended/common/DragDropProperties/libs/DroppablePropertiesEvents',
    'widgets/brXtended/GroupBox/libs/EditorHandles'
], function ({
    config: breaseConfig,
    core: { ContainerWidget, Types, Utils, CommonCSSClasses },
        events: { BreaseEvent },
        decorators: { LanguageDependency, DragAndDropCapability },
        enum: { Enum },
    helper: { scroller },
    controller: { uiController },
    services }, UtilsImage, DroppablePropertiesEvents, EditorHandles) {
     ...
     * true
     *
     * @mixins widgets.brXtended.common.DragDropProperties.libs.DroppablePropertiesEvents
     *
    ...
    */
    ...
    p._initEditor = function () {
        ...
        this.elem.classList.add(CommonCSSClasses.EDITOR_OUTLINE);
    ...
    p.langChangeHandler = function () {
        if (this.settings.textkey !== undefined) {
            _setStaticText.call(this, services.language.getText(this.settings.textkey));
        }
    };
    ...
    function _checkLangDependency() {
        ...
        if (services.language.isKey(this.settings.text) === true) {
            this.settings.textkey = services.language.parseKey(this.settings.text);
    ...
    p.getCurrentText = function () {
        return (this.settings.textkey !== undefined) ? services.language.getText(this.settings.textkey) : this.settings.text;
    };
    ...
    */
    ...
    p._downHandler = function (e) {
        if (this.isDisabled || breaseConfig.editMode || this.isActive) { return; }
        this.isActive = true;
    ...
    p._upHandler = function (e) {
        if (this.isDisabled || breaseConfig.editMode || Utils.getPointerId(e) !== this.pointerId) { return; }
        this.isActive = false;
    ...
    */
    p.getContainer = function () {
        ContainerWidget.prototype.getContainer.apply(this, arguments);
    ...
    p.wake = function () {
        ContainerWidget.prototype.wake.apply(this, arguments);
        this._initEvents();
        if (_isResizable.call(this)) {
            this.debouncedResize();
        }
    ...
    p.suspend = function () {
        ...
        ContainerWidget.prototype.suspend.apply(this, arguments);
    };
    ...
    function _initChildren(widget) {
        var itemDefs = Array.prototype.map.call(widget.getContainer().get(0).children, function (actChild) {
            ...
            if (uiController.getWidgetState(actChild.id) === Enum.WidgetState.READY) {
                def.resolve();
            } else {
    ...
    function _addHeader(widget) {
        ...
        if (widget.settings.text !== undefined && widget.settings.text.length !== 0) {
            var text = ((widget.settings.textkey !== undefined) ? services.language.getText(widget.settings.textkey) : widget.settings.text);
    ...
    function _isResizable() {
        ...
        return breaseConfig.editMode !== true && this.isVisible() === true &&
